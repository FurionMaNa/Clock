...
function draw(){
	gradient = context.createLinearGradient(800, 0, 450, 0);
	context.beginPath();
	context.moveTo(0, 0);
	...
	context.fillRect(0, 0, 900, 720);
	gradient = context.createLinearGradient(350, 0, 450, 0);
	gradient.addColorStop(1, "Red");
	gradient.addColorStop(1, "Red");
	context.fillStyle = gradient;
	context.fillRect(300, 0, 330, 720);
	context.stroke();
	context.beginPath();
